...
public class RuntimeAnalysis {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < LARGE_INPUT_SIZES.length; i++) {
            ArrayList<Integer> largeList = generateArrayList(LARGE_INPUT_SIZES[i]/60);
            ArrayList<Integer> smallList = generateArrayList(SMALL_INPUT_SIZES[i]/10);
...
//            timings.add(measureAndPrintSortingTime("Count Sort", largeList));
    ...
    /**
     * Generates an Ar  rayList of length size
